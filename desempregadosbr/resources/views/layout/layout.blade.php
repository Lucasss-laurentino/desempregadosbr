    ...
    <body class="antialiased" style="height: 100vh;">
        ...
        <nav class="navbar navbar-expand-lg bg-success">
            <div class="container">
                ...
                <button class="navbar-toggler text-white" id="button-collapse" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-menu-down" viewBox="0 0 16 16">
