                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-center my-2">
                            <form action="" style="width: 60%;" class="mt-4">
                                <button class="btn-redes btn btn-sm btn-success border border-success p-2 w-100 d-flex justify-content-center">
                                ...
                                <button class="btn-redes btn btn-success border border-success btn-sm mt-2 p-2 w-100 d-flex justify-content-center">
